...
<div style="overflow: auto; margin-bottom: 20px;"> <img src="{{ '/images/profile-amina-gaffour.png' | prepend: site.baseurl }}" alt="Mgr. Amina Gaffour" style="float: left; margin-right: 15px; width: 200px; height: auto; border-radius: 50%;"> <p> Mgr. Amina Gaffour is an exceptionally well-matched computational chemist whose Ph.D. research covers the entire project workflow. Her expertise spans generating dynamic data through Molecular Dynamics (MD) simulations, accurately calculating key observables using DFT methods (essential for J-coupling analysis), and advanced data processing. Crucially, she specializes in the optimization of UMAP dimensional reduction and K-mean clustering, which is perfect for processing the large MD datasets and classifying the protein's conformational states. This combination ensures she can execute the core computational chemistry tasks and deliver robust, insightful structural analysis of the Tau PRD. </p> </div>
