...
<div style="overflow: auto; margin-bottom: 20px;"> <img src="{{ '/images/profile-amina-gaffour.png' | prepend: site.baseurl }}" alt="Mgr. Amina Gaffour" style="float: left; margin-right: 15px; width: 200px; height: auto; border-radius: 50%;"> <p> Mgr. Amina Gaffour is a perfectly matched computational chemist whose Ph.D. research covers the entire project: Molecular Dynamics (MD) simulations, DFT calculations for J-couplings, and advanced data processing. Crucially, she specializes in the optimization of UMAP dimensional reduction and K-mean clustering, which is ideal for classifying the Tau PRD's. </p> </div>
