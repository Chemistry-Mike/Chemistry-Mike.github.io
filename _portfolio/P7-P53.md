...
<div style="overflow: auto; margin-bottom: 20px;">
  ...
  <p>
    Prof. Marie Skepö, Professor of Theoretical Chemistry at Lund University, played a pivotal role in this project through her deep expertise in the computational biophysics of Intrinsically Disordered Proteins (IDPs). Her group’s rigorous approach to Molecular Dynamics (MD) simulations was instrumental in modeling the conformational ensembles of all four p53 IDRs—TAD1, PRD, PTL, and REG—with high fidelity. In particular, Prof. Skepö led the benchmarking of force fields against experimental NMR and SAXS data, guiding the selection of AMBER99SB-DISP as the optimal model for disordered regions. Her insights into the Proline-Rich Domain (PRD) helped elucidate how PXXP motifs and mutations like P72R and P82L alter local rigidity and signaling potential. Additionally, her team's expertise in PTM-driven dynamics informed the phosphorylation studies across TAD1 and REG, revealing how structural compaction and salt bridge formation modulate p53’s regulatory states. Prof. Skepö’s contributions ensured that the simulation protocols were not only computationally robust but also biologically meaningful, bridging the gap between atomistic modeling and experimental observables.
  </p>
</div>
