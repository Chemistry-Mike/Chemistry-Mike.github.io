...
**Alternative Techniques.** To further enhance the accuracy and convergence of the simulations, various techniques can be used. These include the use of distance restraints, which impose harmonic constraints on certain distances in the system, and the application of thermostats and barostats, which control the temperature and pressure of the system, respectively.
